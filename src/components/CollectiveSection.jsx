...
import { collectiveMembers } from '../data/studioData';
              ...
              <div className="relative aspect-square overflow-hidden bg-zinc-900">
                ...
                <div className="absolute inset-0 flex items-end p-3 translate-y-full group-hover:translate-y-0 transition-all duration-400 bg-gradient-to-t from-rd-black/90 via-rd-black/50 to-transparent">
                  <div className="space-y-1 w-full">
                    <div className="text-[9px] font-black tracking-widest text-rd-red uppercase">{member.experience}</div>
                    <div className="text-[10px] text-zinc-300 leading-tight">{member.speciality}</div>
                  </div>
                </div>
              </div>
